...
@section('content')
    <style>
        .card-header-custom1 {
            background-image: linear-gradient(to right, #a3e2a5d7, #4CAF50);
            /* Gradiente de izquierda a derecha */
            color: #fff;
        }

        .card-header-custom2 {
            background-image: linear-gradient(to right, #f59b95ec, #F44336);
            /* Gradiente de izquierda a derecha */
            color: #fff;
        ...
        .card-header-icono1 {
            background-image: linear-gradient(to right, rgba(174, 197, 224, 0.918), #25045a);
            /* Gradiente de izquierda a derecha */
            color: #fff;
            /* Texto en blanco para contraste */
        }
        ...
        <div class="container-fluid">
                                ...
                                <div id="clientes" class="section">
                                    <div class="col-md-6">
                                        <table id="tablaClientes" class="table  table-bordered table1">
                                            <h3 style="text-align: left">Clientes &nbsp;<i
                                                    class="material-icons">sensor_occupied</i></h3>
                                ...
                                <div id="modulos" class="section">
                                    <div class="container-fluid">
                                        <table id="tablaDinamico3" class="table table-bordered">
                                            <h3 style="text-align: left">Modulo (AQL) &nbsp;<i
                                                    class="material-icons">view_in_ar</i></h3>
                                        ...
                                        <table id="tablaDinamico4" class="table table-bordered">
                                            <h3 style="text-align: left">Modulo (Proceso) &nbsp;<i
                                                    class="material-icons">cable</i></h3>
                                ...
                                <div id="gerentes" class="section">
                                    <div class="container-fluid">
                                        <table id="tablaDinamico" class="table table-bordered">
                                            <h3 style="text-align: left">Gerentes Produccion (AQL) &nbsp;<i
                                                    class="material-icons">view_in_ar</i></h3>
                                            <thead class="thead-custom2 text-center">
                                                <tr>
                                        ...
                                        <table id="tablaDinamico2" class="table table-bordered">
                                            <h3 style="text-align: left">Gerentes Produccion (Proceso) &nbsp;<i
                                                    class="material-icons">cable</i></h3>
                                            <thead class="thead-proceso text-center">
                                                <tr>
            ...
            <div class="row">
              <div class="col-md-12">
                  <div class="card card-stats">
                      <div class="card-header-custom3">
                          <h3 style="font-weight: bold;"><i class="material-icons">select_all</i> Planta 1 - Ixtlahuaca por dia: AQL y PROCESO <a href="dashboarAProcesoAQL" class="btn btn-primary">Detalles por fechas</a></h3>
                      </div>
                      <div class="card-body">
                          <div class="container-fluid">
                              ...
                              <div id="clientes" class="section">
                                  <div class="col-md-6">
                                      <table id="tablaClientes" class="table  table-bordered table1">
                                          ...
                                          <tbody>
                                            @foreach ($dataPlanta1['dataCliente'] as $clienteData)
                                            <tr class="{{ $clienteData['porcentajeErrorProceso'] > 9 && $clienteData['porcentajeErrorProceso'] <= 15 ? 'error-bajo' : ($clienteData['porcentajeErrorProceso'] > 15 ? 'error-alto' : '') }}">
                                              <td>{{ $clienteData['cliente'] }}</td>
                                              <td>{{ number_format($clienteData['porcentajeErrorProceso'], 2) }}%</td>
                                              <td>{{ number_format($clienteData['porcentajeErrorAQL'], 2) }}%</td>
                                          ...
                                          <tr style="background: #ddd">
                                            <td>GENERAL</td>
                                            <td>{{ number_format($totalPlanta1['totalPorcentajeErrorProceso'], 2) }}%</td>
                                            <td>{{ number_format($totalPlanta1['totalPorcentajeErrorAQL'], 2) }}%</td>
                                          </tr>
                                      </table>
                                  </div>
                              </div>
            ...
            <div class="row">
              <div class="col-md-12">
                  <div class="card card-stats">
                      <div class="card-header-custom3">
                          <h3 style="font-weight: bold;"><i class="material-icons">select_all</i> Planta 2 - San Bartolo por dia: AQL y PROCESO <a href="dashboarAProcesoAQL" class="btn btn-primary">Detalles por fechas</a></h3>
                      </div>
                      <div class="card-body">
                          <div class="container-fluid">
                              ...
                              <div id="clientes" class="section">
                                  <div class="col-md-6">
                                      <table id="tablaClientes" class="table  table-bordered table1">
                                          ...
                                          <tbody>
                                            @foreach ($dataPlanta2['dataCliente'] as $clienteData)
                                            <tr class="{{ $clienteData['porcentajeErrorProceso'] > 9 && $clienteData['porcentajeErrorProceso'] <= 15 ? 'error-bajo' : ($clienteData['porcentajeErrorProceso'] > 15 ? 'error-alto' : '') }}">
                                              <td>{{ $clienteData['cliente'] }}</td>
                                              <td>{{ number_format($clienteData['porcentajeErrorProceso'], 2) }}%</td>
                                              <td>{{ number_format($clienteData['porcentajeErrorAQL'], 2) }}%</td>
                                          ...
                                          <tr style="background: #ddd">
                                            <td>GENERAL</td>
                                            <td>{{ number_format($totalPlanta2['totalPorcentajeErrorProceso'], 2) }}%</td>
                                            <td>{{ number_format($totalPlanta2['totalPorcentajeErrorAQL'], 2) }}%</td>
                                          </tr>
                                      </table>
                                  </div>
                              </div>
    ...
    <style>
        ...
        .thead-custom2 {
            ...
            /* Ajusta el color hexadecimal a tu gusto */
            color: #fff;
        ...
        var comparativeChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    weight: [{{ $generalProcesoPlanta1 }},
                        {{ $generalProcesoPlanta2 }}
                    ], // Asigna pesos a los datos
