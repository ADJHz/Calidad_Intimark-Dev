@extends('layouts.app', ['activePage' => 'Auditoria AQL', 'titlePage' => __('Auditoria AQL')])
                                    ...
                                    <div class="col-sm-12 d-flex align-items-center">
                                        <select name="mpo" id="mpo" class="form-control" required title="Por favor, selecciona una opción">
                                            ...
                                            @foreach ($CategoriaTamañoMuestra as $mpo)
                                                <option value="{{ $mpo->id }}">{{ $mpo->nombre }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="col-sm-12 d-flex align-items-center">
                                        <select name="tamaño_muestra" id="tamaño_muestra" class="form-control" required title="Por favor, selecciona una opción">
                                            <option value="">Selecciona una opción</option>
                                            @foreach ($CategoriaTamañoMuestra as $tamaño_muestra)
                                                <option value="{{ $tamaño_muestra->id }}">{{ $tamaño_muestra->nombre }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="col-sm-12 d-flex align-items-center">
                                        <select name="menor" id="menor" class="form-control" required title="Por favor, selecciona una opción">
                                            <option value="">Selecciona una opción</option>
                                            @foreach ($CategoriaDefecto as $menor)
