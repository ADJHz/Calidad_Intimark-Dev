                           ...
                           <div class="card-body">
                               ...
                               <div class="row">
                                   ...
                                   <div class="col-md-6 mb-3">
                                       ...
                                       <div class="col-sm-12">
                                           <select name="izquierda_x" id="izquierda_x" class="form-control" required title="Por favor, selecciona una opción">
                                               <option value="">Selecciona una opción</option>
                                               @foreach ($CategoriaEstilo as $estilo)
                                                   <option value="{{ $estilo->id }}">{{ $estilo->nombre }}</option>
                                               @endforeach
                               ...
                               <div class="row">
                                   ...
                                   <div class="col-md-6 mb-3">
                                       ...
                                       <div class="col-sm-12">
                                           <select name="derecha_x" id="derecha_x" class="form-control" required title="Por favor, selecciona una opción">
                                               <option value="">Selecciona una opción</option>
                                               @foreach ($CategoriaEstilo as $estilo)
                                                   <option value="{{ $estilo->id }}">{{ $estilo->nombre }}</option>
                                               @endforeach
